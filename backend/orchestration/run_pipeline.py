...
# from backend.orchestration.drift_check import feature_drift_report
# from backend.snapshot.build_customer_snapshot import build_customer_snapshot
# from backend.snapshot.utils import load_previous_snapshot
# from backend.snapshot.build_customer_snapshot import SNAPSHOT_DIR
...
#     baseline_path = (
#         MODEL_REGISTRY / model_name / "baseline_stats.json"
#     )
...
#     status = "SEVERE" if drift["severe"] else "OK"
#     print(f"[DRIFT] {model_name}: {status}")
...
#     segmentation_drift = run_drift_check(
...
#     # ===============================================================
#     # 3️⃣ MODEL TRAINING (FEATURE CHANGE OR DRIFT)
#     # ===============================================================
...
#     if retrain_models:
#         print("[STEP] Model training (triggered)")
#         train_models()
#     else:
#         print("[SKIP] Models up-to-date")

#     # ===============================================================
#     # 4️⃣ BATCH INFERENCE + LOGGING
#     # ===============================================================
#     print("[STEP] Batch inference")

#     churn_rows = churn_inference()
#     clv_rows = clv_inference()
#     seg_rows = segmentation_inference()

#     print(f" Churn rows: {churn_rows}")
#     print(f" CLV rows: {clv_rows}")
#     print(f" Segmentation rows: {seg_rows}")
...
# backend/orchestration/run_pipeline.py
